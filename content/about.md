...
I've taught developers at organizations like Chobani and the Boston Globe, and my JavaScript plugins are used by organizations like Apple, Harvard Business School, and CNN. My developer tips newsletter is read by over {{<cta for="mc-subscriber-count">}} developers each weekday.
