...
// Configs
var configs = {
	files: ['main.js', 'fonts.js', 'optOut.js', 'search.js', 'swInit.js'],
	formats: ['iife'],
	default: 'iife',
	pathIn: 'src/js',
	pathOut: 'static/js',
...
// Banner
var banner = `/*! ${configs.name ? configs.name : pkg.name} v${pkg.version} | (c) ${new Date().getFullYear()} ${pkg.author.name} | ${pkg.license} License | ${pkg.repository.url} | Credits: ${pkg.openSourceCredits} */`;
