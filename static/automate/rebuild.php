<?php
	...
	exec('cd /srv/users/serverpilot/apps/vanillajslist/build && /usr/local/bin/hugo && cp -r /srv/users/serverpilot/apps/vanillajslist/build/public/. /srv/users/serverpilot/apps/vanillajslist/public');
